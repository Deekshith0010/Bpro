                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <?php
                      $count=1;
                      $stmt=$admin->ret("SELECT *FROM `session_book` INNER JOIN `user` ON user.user_id=session_book.user_id INNER JOIN `session_gym` ON session_gym.sg_id=session_book.sg_id INNER JOIN `session` ON session.session_id=session_gym.session_id WHERE session_book.urequest_date BETWEEN '$start_date' AND '$end_date' AND session_book.tr_id='$tid' AND session_book.urequest_status='accepted'");
