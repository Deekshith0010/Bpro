        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase">Personal Trainer Login</h2>
              <p class="text-white-50 mb-5">Please enter your login and password!</p>


              <form action="trainer/controller/trainerlogin.php" method="post">
              ...
              <button class="btn btn-outline-light btn-lg px-5" type="submit" name="trainerlogin">Login</button>
            ...
            <div>
              <p class="mb-0">Don't have an account? <a href="trainerregister.php" class="text-white-50 fw-bold">Sign Up</a>
              </p>
            </div>
