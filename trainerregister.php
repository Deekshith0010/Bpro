        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase">Trainer Registration</h2>
              <p class="text-white-50 mb-5">Please enter your details!</p>


                <form action="trainer/controller/trainerregister.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-outline form-white mb-4">
                <input type="date" id="typeEmailX" name="dob" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">Date of Birth</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" name="weight" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">Weight</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" name="height" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">height</label>
              </div>

              
              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" name="occuption" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">occuption</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" name="exp" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">Years of Experience</label>
              </div>

              
              <div class="form-outline form-white mb-4">
                <input type="text" id="typeEmailX" name="know" class="form-control form-control-lg" required/>
                <label class="form-label" for="typeEmailX">Knowledge</label>
              </div>
              ...
              <button class="btn btn-outline-light btn-lg px-5" type="submit" name="trainerregister">Register</button>
            ...
            <div>
              <p class="mb-0">Already a user? <a href="trainerlogin.php" class="text-white-50 fw-bold">Login</a>
              </p>
            </div>
