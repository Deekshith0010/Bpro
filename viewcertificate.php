            ...
            <?php 
                ...
                while($row=$stmt->fetch(PDO::FETCH_ASSOC)){ ?>
                    <div class="gs-item grid-wide set-bg">
                        <img src="gym/controller/<?php echo $row['gym_cert'] ?>" alt="" style="width:500px;height:400px"> 
                <a href="gym/controller/<?php echo $row['gym_cert'] ?>" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
              <?php  }
            ?>
